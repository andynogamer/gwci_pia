...
- Subscribe: `GAME_START`, `GAME_PAUSE`, `SETTINGS_UPDATED`, `ROOM_READY` (PVP pads), `MATCH_END` (PVP abort / peer leave), `PICKUP_TAKEN` (PVP hide loot), remote fire / remote `CLIENT_STATE_UPDATE` translated by Network onto the bus
